 ...
 * @author alilo
 */
public class GestProduitsPanel extends MasterDetailsPanel {

    private static final String CAT_SPLIT_POS = "mainProdCatSplitPos";
    private static final String PROD_SPLIT_POS = "mainProdProdSplitPos";

    ListeFamillesPanel famillesPanel;
    ListeCategoriesPanel categoriesPanel;
    ListeProduitsPanel produitsPanel;
     ...
     * @param prodP
     */
    public GestProduitsPanel(ListeFamillesPanel famP, ListeCategoriesPanel catP, ListeProduitsPanel prodP) {
        initComponents();
        if (famP == null) {
            ...
            famillesPanel = famP;
            famillesPanel.setOwnerPanel(GestProduitsPanel.this);
        }
        ...
        if (catP == null) {
            categoriesPanel = new ListeCategoriesPanel(this, false) {
                ...
                public void reload() {
                    super.reload();
                    produitsPanel.reload();
                }

            };
        } else {
            categoriesPanel = catP;
            categoriesPanel.setOwnerPanel(GestProduitsPanel.this);
        }

        if (prodP == null) {
            produitsPanel = new ListeProduitsPanel(this, false, true);
        } else {
            produitsPanel = prodP;
            produitsPanel.setOwnerPanel(GestProduitsPanel.this);
        }
        
        categoriesPanel.setMasterPanel(famillesPanel, null);
        produitsPanel.setMasterPanel(categoriesPanel, "ID_CATEG");
        produitsPanel.setMasterPanel(famillesPanel, "ID_FAM");

        prodHolderP.add(produitsPanel);
    ...
    private void initComponents() {
        ...
        categHolderP.setBorder(javax.swing.BorderFactory.createTitledBorder(null, " Catégories (Ctrl+T)", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                frame.setTitle("Test");
                frame.add(new GestProduitsPanel(null, null, null));
                frame.pack();
