 ...
 * @author alilo
 */
public class UpdateDBDialog extends dialogs.MyJDialog {

    private static UpdateDBDialog instance;
     ...
     * @param modal
     */
    public UpdateDBDialog(java.awt.Frame parent, boolean modal) {
        ...
        chooser.setFileFilter(new FileFilter() {
            ...
            public String getDescription() {
                return "Selectionner un fichier script (.sql)";
            }
        });
        chooser.setAcceptAllFileFilterUsed(false);
        chooser.setCurrentDirectory(new File(DBManager.getInstance().getSqlUpdateFile()).getParentFile());
    }

    public static UpdateDBDialog getInstance() {
        if (instance == null) {
            return new UpdateDBDialog(null, true);
        } else {
            return instance;
        }
    }
    ...
    public void startUpdate() {
        while (sqlFile == null) {
            JOptionPane.showMessageDialog(this, "Sélectionner le fichier du script SVP!", "Attention", JOptionPane.ERROR_MESSAGE);
            browse();
        }
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                DBManager.getInstance().updateDB(sqlFile);
                setVisible(false);
            }
        }).start();
    }
    ...
    public void browse() {
        try {
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                sqlFile = f.getCanonicalPath();
                pathArea.setText("A partire: "+sqlFile);
            }
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Maintenance du la base de données");
        ...
        imagePanel2.setImgLocationPath("/res/icons/dbFixe128.png");
        ...
        browseLinkButton.setForeground(new java.awt.Color(0, 0, 0));
        browseLinkButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/actions/browse24.png"))); // NOI18N
        browseLinkButton.setText("Selectionner le fichier du script par ici!");
        ...
        waitLabel.setText("Opération en cours patientez SVP! .....");
        ...
        importLinkButton.setForeground(new java.awt.Color(0, 0, 0));
        importLinkButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/icons/tool24.png"))); // NOI18N
        importLinkButton.setText("Clicker ici pour commencer");
