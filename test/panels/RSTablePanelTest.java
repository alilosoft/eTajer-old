 ...
 * @author alilo
 */
public class RSTablePanelTest extends javax.swing.JFrame {

    /**
     * Creates new form RSTablePanelTest
     */
    public RSTablePanelTest() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RSTablePanelTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RSTablePanelTest().setVisible(true);
            }
        });
    }
